...
public class StaffManagerFrame extends JFrame implements ActionListener{
	...
	JTextField TName, TAge, TId, TGender, TRole, TSearch;
	...
	public void actionPerformed(ActionEvent e){
		...
		public void tableModuleToList(){
			...
			StaffList updatedList = new StaffList(100);
			for(int i=0; i<rows; i++){
				...
				String role =table.getModel().getValueAt(i, 4).toString();
				
				Staff staff = new Staff(id,name,age,gender,role);
				updatedList.insertStaff(staff);
			}
			staffList.setAllStaffs(updatedList.getAllStaff());
