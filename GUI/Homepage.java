...
{	
	JPanel panel;
	JButton btnPatientManager, btnDoctorManager, btnStaffManager,btnAppointManager, logout;
	JLabel label;
	...
	public Homepage(Login login, PatientList patientList, DoctorList doctorList, StaffList staffList,AppointmentList appointmentList){
		super("Homepage");
		this.login = login;
        ...
        btnPatientManager.setBounds(230, 70, 250, 60);
        ...
        btnDoctorManager.setBounds(230, 150, 250, 60);
        ...
        btnStaffManager.setBounds(230, 230, 250, 60);
		...
		btnAppointManager = new JButton("Appointment Manager");
        btnAppointManager.setBounds(230, 310, 250, 60);
        btnAppointManager.setFont(font);
		btnAppointManager.setForeground(Color.WHITE);
		btnAppointManager.setBackground(new Color(76, 141, 245));
        btnAppointManager.addActionListener(this);
        this.add(btnAppointManager);
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if(btnAppointManager == e.getSource()){
			new AppointmentManagerFrame(this, appointmentList);
			this.setVisible(false);
		}
