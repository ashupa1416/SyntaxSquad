...
public class PatientManagerFrame extends JFrame implements ActionListener{
	...
	JTextField TName, TAge, TId, TGender, TBP, TSearch;
	...
	public void actionPerformed(ActionEvent e){
		...
		public void tableModuleToList(){
			...
			PatientList updatedList = new PatientList(100);
			for(int i=0; i<rows; i++){
				...
				String bloodPressure =table.getModel().getValueAt(i, 4).toString();
				
				Patient pat = new Patient(id,name,age,gender,bloodPressure);
				updatedList.insertPatient(pat);
			}
			patientList.setAllPatients(updatedList.getAllPatient());
